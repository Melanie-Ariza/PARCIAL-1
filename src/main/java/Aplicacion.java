    ...
    static void main() throws ParseException {
        ...
        if (opcion==1){
            ...
            do {
                ...
                System.out.println("6. Actualizar compra.");
                System.out.println("7. Eliminar compra.");
                System.out.println("8. Mostrar compra.");
                System.out.println("----------------------------------------");
                System.out.println("9. Agregar producto.");
                System.out.println("10. Actualizar productos.");
                System.out.println("11. Eliminar productos.");
                System.out.println("12. Mostrar productos.");
                System.out.print("Seleccione la opción: ");
                opcion= sc.nextInt();
                sc.nextLine();
                switch (opcion){
